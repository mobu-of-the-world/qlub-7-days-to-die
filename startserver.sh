#!/bin/sh
# ORIGINALLY COPIED FROM /7-days-to-die/startserver.sh
SERVERDIR=`dirname "$0"`
cd "$SERVERDIR"
...
exec ./7DaysToDieServer.x86_64 -logfile $SERVERDIR/output_log.txt -quit -batchmode -nographics -dedicated $PARAMS
